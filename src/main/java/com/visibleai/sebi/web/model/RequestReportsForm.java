...
public class RequestReportsForm implements Serializable {
  ...
  public String toString() {
    return "RequestReportsForm [startDate=" + startDate + ", endDate=" + endDate + ", generateAllReports="
        + generateAllReports + ", generateMediaVisitorReport=" + generateMediaVisitorReport + ", generateBrokerReport="
        + generateBrokerReport + ", generateEmployeeWatchReport=" + generateEmployeeWatchReport
        + ", generateGovtReport=" + generateGovtReport + ", generateVisitorWatchListReport="
        + generateVisitorWatchListReport + ", generateFreqencyCheck7=" + generateFreqencyCheck7
        + ", generateFreqencyCheck14=" + generateFreqencyCheck14 + ", generateFreqencyCheck30="
        + generateFreqencyCheck30 + ", generateOutOfOfficeHoursReport=" + generateOutOfOfficeHoursReport + ", emailTo="
        + emailTo + "]";
  }
