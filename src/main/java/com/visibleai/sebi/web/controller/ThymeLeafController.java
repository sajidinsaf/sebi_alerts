...
public class ThymeLeafController {
    ...
    public String getVisitorEntries(@ModelAttribute RequestReportsForm requestReportsForm, Model model,
            ...
            @Value("${mail.text}") String mailText, @RequestParam("brokerListFile") MultipartFile brokerListFile,
            @RequestParam("employeeWatchListFile") MultipartFile employeeWatchListFile,
            @RequestParam("governmentListFile") MultipartFile governmentListFile,
            @RequestParam("visitorWatchListFile") MultipartFile visitorWatchListFile) throws IOException {
